const MUSIC_LIBRARY = [
    {
        ...
        children: [
            { name: "Queen", audio: "assets/rock.mp3" }, // Re-using for test
            { name: "Nirvana", audio: "assets/rock.mp3" },
            { name: "AC/DC", audio: "assets/rock.mp3" },
            { name: "Pink Floyd", audio: "assets/rock.mp3" },
            { name: "Led Zeppelin", audio: "assets/rock.mp3" },
            { name: "The Rolling Stones", audio: "assets/rock.mp3" },
            { name: "The Beatles", audio: "assets/rock.mp3" },
            { name: "Metallica", audio: "assets/rock.mp3" }
        ]
    },
    {
        name: "Pop",
        ...
        children: [
            ...
            { name: "Michael Jackson", audio: "assets/pop.mp3" },
